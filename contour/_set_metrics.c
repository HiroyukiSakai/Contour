/* Generated by Cython 0.19.1 on Tue Jan 28 22:36:47 2014 */
...
static char __pyx_doc_7Contour_7contour_12_set_metrics_hausdorff_distance_onesided[] = "\n    Compute the one-sided Haussdorff distance between two sets of points.\n    ";
...
static PyObject *__pyx_pf_7Contour_7contour_12_set_metrics_hausdorff_distance_onesided(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_points_sup, __Pyx_memviewslice __pyx_v_points_inf) {
  ...
  /* "Contour/contour/_set_metrics.pyx":20
 *     Compute the one-sided Haussdorff distance between two sets of points.
 *     """
 ...
 */
  ...
  /* "Contour/contour/_set_metrics.pyx":22
 *     assert points_sup.shape[1] == points_inf.shape[1]
 * 
 *     cdef double d2_max = 0.             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "Contour/contour/_set_metrics.pyx":23
 * 
 *     cdef double d2_max = 0.
 *     cdef double d2_min_i = MAX_FLOAT64             # <<<<<<<<<<<<<<
 *     cdef double d2_j = 0.
 ...
 */
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s__MAX_FLOAT64); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "Contour/contour/_set_metrics.pyx":24
 *     cdef double d2_max = 0.
 *     cdef double d2_min_i = MAX_FLOAT64
 *     cdef double d2_j = 0.             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t i, j, k
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "Contour/contour/_set_metrics.pyx":28
 * 
 *     for i in range(points_sup.shape[0]):
 *         d2_min_i = MAX_FLOAT64             # <<<<<<<<<<<<<<
 *         for j in range(points_inf.shape[0]):
 *             d2_j = 0.
 */
    __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s__MAX_FLOAT64); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 28; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
 ...
 */
      ...
      for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
        ...
        /* "Contour/contour/_set_metrics.pyx":32
 *             d2_j = 0.
 *             for k in range(points_sup.shape[1]):
 *                 d2_j += (points_sup[i, k] - points_inf[j, k])**2             # <<<<<<<<<<<<<<
 *             d2_min_i = d2_min_i if d2_min_i < d2_j else d2_j
 ...
 */
      ...
      /* "Contour/contour/_set_metrics.pyx":33
 *             for k in range(points_sup.shape[1]):
 *                 d2_j += (points_sup[i, k] - points_inf[j, k])**2
 *             d2_min_i = d2_min_i if d2_min_i < d2_j else d2_j             # <<<<<<<<<<<<<<
 *         d2_max = d2_max if d2_max > d2_min_i else d2_min_i
 ...
 */
  ...
  __pyx_t_1 = PyFloat_FromDouble(sqrt(__pyx_v_d2_max)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
