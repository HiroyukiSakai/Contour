...
This is useful when the images of many entries have changed.
...
This removes information which was generated by the players through gameplay (drawings, high scores, etc.). *Handle with care*.
